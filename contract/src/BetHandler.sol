...
import "../lib/uma/packages/core/contracts/optimistic-oracle-v2/interfaces/OptimisticOracleV2Interface.sol";
import "../lib/openzeppelin-contracts/contracts/utils/ReentrancyGuard.sol";


contract BetHandler is ReentrancyGuard {
    // Create an Optimistic oracle instance at the deployed address on Görli.
    OptimisticOracleV2Interface oo =
        OptimisticOracleV2Interface(0xAAE2Ac149A40E017F158446A72a23b1ef5F85dC2);
